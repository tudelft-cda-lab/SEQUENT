from sequent.ff_result_processor import *
from sequent.model_operations import *
from sequent.root_cause_operations import *
import pandas as pd 

class SEQUENT:
    def __init__(self, model:str, output_folder: str, ini_folder:str):
        """
        Contructs an object of the SEQUENT class.

        :param model: The type of model that should be learned using SEQUENT. Currently, we only support Markov Chains and State Machines 
        :param output_path: The path where the output files of SEQUENT should be stored.
    ...
    def group_predictions(prediction_results: pd.DataFrame, netflow_records: pd.DataFrame) -> dict():
        ...
        :param prediction_results: The prediction results generated by SEQUENT.
